...
<intl>
    ...
    <nav class="w3-dropdown-hover">
        <button class="w3-button w3-border-0">intl</button>
        <ul class="w3-dropdown-content">
            <li>
                <a href="/sphinx-demo/">Home</a>
            </li>
            <li>
                <a href="/sphinx-demo/en">en</a>
            </li>
        </ul>
        <div >
    </nav>
...
html_baseurl = 'https://xinetzone.github.io/sphinx-demo'
sitemap_locales = ['zh_CN', 'en']
sitemap_url_scheme = "{lang}{link}" # "{version}{lang}{link}"
